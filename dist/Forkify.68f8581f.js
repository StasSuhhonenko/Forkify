...
$40778e22ccaf12bb$exports = /ipad|iphone|ipod/i.test($0e3acfdad29bed32$exports) && /applewebkit/i.test($0e3acfdad29bed32$exports);
...
const $949cefe0e606d775$export$7167c830cefcb6b5 = '5d37a2b5-f102-496b-b5ec-4b25e927f885';
...
const $f821677b80d93c23$export$ca000e230c0caa3e = {
    ...
    search: {
        ...
        results: [],
        page: 1,
        resultsPerPage: (0, $949cefe0e606d775$export$d2f17d20365655cb)
    },
    bookmarks: []
};
...
const $f821677b80d93c23$export$136048bcb9946c75 = function(idOfBookmark) {
    // Delete bookmark
    const index = $f821677b80d93c23$export$ca000e230c0caa3e.bookmarks.findIndex((el)=>el.id === idOfBookmark);
    $f821677b80d93c23$export$ca000e230c0caa3e.bookmarks.splice(index, 1);
    // Mark current recipe as without a bookmark
    if (idOfBookmark === $f821677b80d93c23$export$ca000e230c0caa3e.recipe.id) $f821677b80d93c23$export$ca000e230c0caa3e.recipe.bookmarked = false;
    $f821677b80d93c23$var$persistBookmarks();
};
...
class $87c8fee486b3a62a$var$RecipeView extends (0, $66df3411d2d6676e$export$2e2bcd8739ae039) {
    ...
    _errorMessage = "Wrong ID! We couldn't find the recipe! Try again!";
    _message;
    ...
    addHandlerUpdateServings(handler) {
        this._parentElement.addEventListener('click', function(e) {
            ...
            if (!btn) return;
            const updateTo = +btn.dataset.updatedTo;
            ...
            <div class="recipe__details">
              ...
              <div class="recipe__info">
                ...
                <div class="recipe__info-buttons">
                  <button class="btn--tiny btn--update-servings" data-updated-to="${this._data.servings - 1}">
                    <svg>
...
class $3a43958ee387c94d$var$AddRecipeView extends (0, $66df3411d2d6676e$export$2e2bcd8739ae039) {
    ...
    _message = 'Recipe was successfully uploaded! Nice Add!';
...
const $51e55805949f51d8$var$controlRecipes = async function() {
    try {
        //// Getting hash id from browser url/search bar--------------------------------------------------
        const id = window.location.hash.slice(1);
        if (!id) return;
        //// Loading spinner------------------------------------------------------------------------------
        ...
        //// Step 1 - Calling the load recipe function from model.js--------------------------------------
        await $f821677b80d93c23$export$b96725c7a035d60b(id);
        //// Step 2 - Rendering Recipe on a page----------------------------------------------------------
...
const $51e55805949f51d8$var$controlPagination = function(goToPage) {
    ...
    // 4) Render NEW starting pagination
    (0, $ea55b24677fb9333$export$2e2bcd8739ae039).render($f821677b80d93c23$export$ca000e230c0caa3e.search);
};
...
const $51e55805949f51d8$var$clearBookmarks = function() {
    localStorage.clear('bookmarks');
};


//# sourceMappingURL=Forkify.68f8581f.js.map
